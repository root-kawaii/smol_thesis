## Questi modelli sono una modifca a quello importato da 
...
4096/128=32 quindi average pooling size in blocks 1 and 2 devono essere 32 volte più grandi
...
#block2       = SeparableConv2D(F2, (1, 16), use_bias = False, padding = 'same') (block1)
    ...
    block2       = SeparableConv2D(F2, (1, kernLength//4), 
...
def EEGNet2(nb_classes, Chans = 16, Samples = 1000, 
