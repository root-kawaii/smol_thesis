...
% \begin{figure}[h]
%     \centering
%     % \includegraphics[scale=0.3]{ble_packet_format.png}
...
\centering
\includegraphics[scale=0.7]{Bluetooth_Security/3.png}
% \caption{Summary of the pairing procedure, including Phase 3. Source: \url{https://academy.nordicsemi.com/courses/bluetooth-low-energy-fundamentals/lessons/lesson-5-bluetooth-le-security-fundamentals/topic/pairing-process/}}
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[scale=0.3]{peer_manager_architecture.png}
...
% \caption{Timers functioning overview}
\label{fig:timers}
\end{figure}
...
% \caption{State machine for PC process}
